...
const dict: Dictionary = {
  ...
  about: {
    ...
    eyebrow: 'About',
    impact:
      '大きな構想を語るより先に、人が実際に使えてチームが運用し続けられるプロダクトを形にする仕事を長くしてきました。フィンテック、ブロックチェーン、SaaS、AIを行き来してきましたが、繰り返してきたのは複雑さを減らし、試作から本番までの距離を短くすることです。',
    stat1Label: '実務経験',
    stat1Suffix: '年+',
    stat2Label: '0→1サービス',
    stat2Value: '6件+',
    ...
    philosophyTitle: '仕事に向き合う姿勢',
    philosophy1:
      '履歴書には数字が残りますが、私がより重視するのは、その数字を支える構造です。慌てずにロールバックできるデプロイ基盤、障害時にも崩れない決済・精算フロー、判断が必要な場面で人に余地を残す運用画面を丁寧に作ってきました。',
    philosophy2:
      'LinkedInや履歴書には役割と成果が残り、GitHubや文章には考え方が残ると思っています。だから公開するコードや文書でも、何を作ったかだけでなく、なぜその構造にしたのかが伝わる状態を目指しています。新しい道具は早く取り入れますが、責務の境界と観測可能性にはより厳しく向き合います。',
    philosophy3:
      '最近はLLMやエージェントをプロダクトやバックオフィスのワークフローに繋ぐことが増えました。ただ、自動化そのものを美化はしません。システムが安全に繰り返せることと、人が最終判断すべきことをはっきり分ける方を好みます。速く作ることより、速く作っても長く運用できる状態を残すことを大切にしています。',
    domainsTitle: 'ドメイン経験',
    domains: {
  ...
  experience: {
    ...
    items: {
      masblue: {
        ...
        summary: '保険バックオフィスをエージェント・オーケストレーションへ再構成',
        metric: 'パイロット50件 · 20分 → 4分',
        bullets: [
      ...
      onto: {
        ...
        summary: 'オンサイト推論とR2アップロードをつなぐ映像基盤を設計',
        metric: 'アップロード成功率99.7% · カメラ8台',
        bullets: [
      ...
      rootstone: {
        company: 'Rootstone',
        summary: '機関顧客向けトレーディングレポートと裁定エンジンを運用',
        metric: 'バッチ成功率99.9% · 1日平均3,000件',
        bullets: [
      ...
      dio: {
        ...
        summary: '複数の0→1サービスで決済・精算・LLMフローを実装',
        metric: '8週ローンチ · 2,500チェックイン · 12名パイロット',
        bullets: [
      ...
      dssolve: {
        company: 'DS Solve',
        summary: '設定主導で拡張できるRandibotマルチテナント基盤を構築',
        metric: '5ワークスペース · 月1,200件のETL',
        bullets: [
      ...
      miso: {
        company: 'Miso Inc.',
        summary: 'レガシー移行を含むCognito認証基盤を構築',
        metric: '12万人移行 · 失敗率0.5%以下',
        bullets: [
      ...
      flfi: {
        company: 'FLFI',
        summary: 'フィンテック基盤のバックエンドと配備体制をチームで再設計',
        metric: '500回超の無停止デプロイ · 1日3回配備',
        bullets: [
      ...
      aligo: {
        company: 'ALIGO',
        summary: '大規模業務メッセージAPIと送信キュー基盤を運用',
        metric: '日500万件 · ピーク3,000 RPS',
        bullets: [
      ...
      'studio-bloom': {
        ...
        summary: 'P2P貸付プロダクトとフィンテック精算フローを開発',
        metric: '累計12万件取引 · 整合性事故0件',
        bullets: [
      ...
      ninefive: {
        company: 'Ninefive',
        summary: 'プロモーション演出とアクセシビリティ品質を両立',
        metric: '滞在・スクロールKPI · アクセシビリティ基準達成',
        bullets: [
      ...
      '4depth': {
        company: '4depth',
        summary: '公共サイトのパブリッシングとアクセシビリティ対応を担当',
        metric: '公共プロジェクト14件 · K-WCAG認証',
        bullets: [
