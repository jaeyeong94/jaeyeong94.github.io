const dict = {
  ...
  about: {
    ...
    eyebrow: 'About',
    impact:
      '처음부터 거창한 플랫폼을 말하기보다, 사람들이 실제로 쓰고 팀이 끝까지 운영할 수 있는 제품을 만드는 일을 오래 해 왔습니다. 핀테크, 블록체인, SaaS, AI를 오가며 결국 같은 일을 반복해 왔습니다. 복잡한 흐름을 단순한 시스템으로 정리하고, 프로토타입에서 프로덕션까지 거리를 좁히는 일입니다.',
    stat1Label: '실무 경력',
    stat1Suffix: '년+',
    stat2Label: '0→1 서비스',
    stat2Value: '6건+',
    ...
    philosophy1:
      '이력서에는 숫자가 남지만, 제가 더 중요하게 보는 건 그 숫자를 버티게 하는 구조입니다. 당황하지 않고 롤백할 수 있는 배포 체계, 실패 상황에서도 어긋나지 않는 결제·정산 흐름, 사람이 마지막 판단을 내릴 수 있게 남겨둔 운영 화면. 이런 것들을 꾸준히 설계해 왔습니다.',
    philosophy2:
      'LinkedIn과 이력서에는 역할과 숫자가 남고, GitHub와 글에는 사고방식이 남는다고 생각합니다. 그래서 공개된 코드와 문서도 무엇을 만들었는지뿐 아니라, 왜 그런 구조를 택했는지가 드러나길 바랍니다. 새 도구는 빠르게 받아들이되, 책임 경계와 관측 가능성은 더 엄격하게 챙기는 편입니다.',
    philosophy3:
      '최근에는 LLM과 에이전트를 제품과 백오피스에 연결하는 일을 자주 합니다. 다만 자동화를 과장하지는 않습니다. 시스템이 안전하게 반복할 수 있는 일과 사람이 끝까지 판단해야 하는 일을 분리하는 쪽을 선호합니다. 빨리 만드는 것보다, 빨리 만들고도 오래 운영할 수 있는 상태를 남기는 개발자이고 싶습니다.',
    domainsTitle: '도메인 연차',
    domains: {
      fullstack: '풀스택 / 백엔드',
      fintech: '핀테크',
  ...
  manifesto: {
    ...
    actions: [
      '반복 업무와 운영 병목을 자동화할 수 있는 워크플로우로 바꿉니다.',
      '작게 프로토타입을 만들고, 지표와 사용자 피드백을 보며 다음 단계를 정합니다.',
      '새 도구는 빠르게 받아들이되, 프로덕션 품질 기준은 더 엄격하게 봅니다.',
    ],
